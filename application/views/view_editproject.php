                                ...
                                <form role="form" action="" method="POST" enctype="multipart/form-data">
                                    <div class="box-body">
                                      <div class="form-group">
                                          ...
                                          <br/>
                                          <h4><?php echo $project[0]['project_name']?></h4>
                                      </div>


									<div class="form-group">
                                        <label for="organisationname">Project Code<sup>*</sup></label>
                                        <input type="text" value="<?php echo $project[0]['project_code']?>"  required class="form-control" name='project_code' id='project_code' >
                                    </div>
                                    <div class="form-group">
									...
									<div class="form-group">
                                        <label for="organisationname">Contact Number</label>
                                         <input type="text"  value="<?php echo $project[0]['project_contact']?>" class="form-control" name='project_contact' id='project_contact' >
                                    </div>

									<div class="form-group">
                                        <label for="organisationname">Fax Number</label>
                                       <input type="text"  value="<?php echo $project[0]['project_fax']?>" class="form-control" name='project_fax' id='project_fax' >
                                    </div>
									...
									<div class="form-group">
                                      ...
                                      <select name="project_country"  id='project_country' class="form-control">
                                        <?php foreach($countryList as $s){?>
                                          <option <?php if($project[0]['project_country']==$s['Code']) echo 'selected';?> value='<?php echo $s['Code']?>'><?php echo $s['Name']?></option>
                                        <?php } ?>
                                      </select>
                                    </div>
									...
									<div class="form-group">
                                      ...
                                      <select name="project_city" id='project_city' class="form-control">
                                        <?php foreach($cityList as $s){?>
                                            <option <?php if($project[0]['project_city']==$s['ID']) echo 'selected';?> value='<?php echo $s['ID']?>'><?php echo $s['Name']?></option>
                                        <?php } ?>
                                      </select>
                                    </div>
									<div class="form-group">
                                        <label for="organisationname">Project Address<sup>*</sup></label>
                                       <input type="text" required value="<?php echo $project[0]['project_address']?>" class="form-control" name='project_address' id='project_address' >
                                    </div>

								
									<div class="form-group">
                                        <label for="organisationname">Project Start Date<sup>*</sup></label>
                                       <input type="text" required class="form-control" value="<?php echo $project[0]['project_start_date']?>" name='project_start_date' id='project_start_date' >
                                    </div>

									<div class="form-group">
                                        <label for="organisationname">Estimated Completion Date <sup>*</sup></label>
                                        <input type="text" required class="form-control" value="<?php echo $project[0]['project_estimated_completion_date']?>" name='project_estimated_completion_date' id='project_estimated_completion_date' >
                                    </div>
                                    <div class="form-group">
									...
									<div class="form-group">
                                       ...
                                       <textarea required class="form-control" name='project_description' id='project_description' required><?php echo $project[0]['project_description']?></textarea>
                                    </div>


                                    </div><!-- /.box-body -->
									<div class="box-footer">
                                        <button type="submit" id='saveBtn' class="btn btn-primary" name='updateProject' value='save'>Update</button>
                                    </div>
                                </form>
                            </div><!-- /.box -->
