                                ...
                                <form role="form" action="" method="POST" enctype="multipart/form-data">
                                    <div class="box-body">
                                      <div class="form-group col-md-6">
                                        ...
                                        <input type="text" required class="form-control " name='documentnumber' id='documentnumber' value="<?php echo $submittal[0]['document_number']?>">
                                      </div>
                                      <div class="form-group col-md-6">
                                        <label for="organisationcontact">
                                        Revision
                                        </label>
                                      <input type="text" required class="form-control " name='revision' id='revision' value="<?php echo $submittal[0]['revision']?>">
                                      </div>

                                    <div class="form-group col-md-6">
                                        <label for="description"><?php echo $this->lang->line('TITLE')?></label>
                                        <input type="text" required class="form-control " name='description' id='description' value="<?php echo $submittal[0]['description']?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                      <label for="organisationcontact">
                                      Type
...
'C - Revised and Re-submit',
'D - Rejected',
'F-Information Only',
'S - Superseded',
'X - Not Yet Completed');
									foreach($statusArray as $s){
										if($submittal[0]['status']==$s)
...
'R2M'
									...
									$szArray=explode(",",$submittal[0]['sub_zone']);
									foreach($subZoneArray as $sz){
										if(in_array($sz,$szArray))
										  echo "<option selected value='".$sz."'>".$sz."</option>";
									  else
...
?>
                	...
                	<div class="form-group col-md-6">
									...
									<div class="form-group col-md-12">
                                        <label for="organisationcontact">
										Remarks</label>
                                         <textarea class="textarea" placeholder="Write your remark here" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $submittal[0]['comments']?></textarea>
                                    </div>
									...
									<div class="box-footer " style="float:left">
                                        <button type="submit" id='saveBtn' class="btn btn-primary" name='update' value='save'>Update</button>
                                    </div>
                                </form>
                            </div><!-- /.box -->
